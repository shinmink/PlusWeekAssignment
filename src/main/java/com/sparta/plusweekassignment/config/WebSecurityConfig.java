package com.sparta.plusweekassignment.config;

import com.sparta.plusweekassignment.domain.user.repository.UserRepository;
import com.sparta.plusweekassignment.security.JwtAuthenticationFilter;
import com.sparta.plusweekassignment.security.JwtAuthorizationFilter;
import com.sparta.plusweekassignment.security.UserDetailsServiceImpl;
import com.sparta.plusweekassignment.security.jwt.JwtService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authorizeHttpRequests) ->
                authorizeHttpRequests
                        ...
                        .requestMatchers("/api/user/naver/callback").permitAll()
